	...
	return (
        <div className="w-full overflow-x-hidden h-fit bg-primary">
            ...
            <div className="relative flex flex-col justify-center py-8 h-[60vh]">
                ...
                >
                    <motion.div className="absolute left-12" variants={FADE_UP_ANIMATION_VARIANTS}>
                        <CardView
                    ...
                    <motion.div className="absolute translate-y-12 right-16" variants={FADE_UP_ANIMATION_VARIANTS}>
                        <CardView
            ...
            <div className="flex flex-col items-center justify-center py-8">
                ...
                <p className="mt-2 text-sm font-medium text-center font-montserrat">
                    University of Information Technology - VNU Han Thuyen street, Linh Trung Ward, Thu Duc City, HCMC
                </p>
                <div>
                    <iframe
