...
export type ViewContextType = {
    ...
    guest: {
        ...
        fetchGuest: (inviter: User | null, guestName: string | undefined) => Promise<Guest | null>;
    };
    formMethod: {
...
const ViewContextProvider = ({children}: {children: React.ReactNode}) => {
    ...
    const fetchInviter = async (inviterName: string | undefined): Promise<User | null> => {
        if (inviterName) {
    ...
    const fetchGuest = async (inviter: User | null, guestName: string | undefined): Promise<Guest | null> => {
